...
|游戏名|问题|
| :-: | :-: |
| 流星·世界演绎者 | 无法调整字体；无法调整系统语音；无法调整每个项目的确认框是否出现；不会记住窗口大小和状态；backlog 打断语音；backlog 时鼠标本身位置的文本无法点击 |
| AIR | <text style="color:red;">音量设置无反应，所有我重视的音量相关设置项全部无法调整，语音被打断；没有 backlog</text>；默认全屏模式爆改系统分辨率；滚轮无绑定；背景色调整无透明度，无法恢复最初状态 |
