...
悬疑 + 变态连发，总感觉比拔作岛还有意思（我就吃悬疑这一套

- 开局拔作岛既视感，哔哔！我 H 回路亮了！
- bgm 设置的也不行，好几次的 bgm 不符合当场氛围。
- 原画：有不少画风崩坏的情况。
  - 我实在不知道，头发把眼睛完全挡住了为什么还要画出来……（见摩天轮 CG）
  - 经典斗鸡眼
  - 这个原画给我的感觉就是 把人物画斜不是为了场景需求，而是为了掩盖瑕疵……
  - 不过也有好的，~~比如我非常喜欢艾佩理雅白眼图~~
- 本作非常注重逻辑，是我见过的时穿作品中相对严谨的一部。
- 对超现实还在物理小教学（双缝干涉）的作品不太感冒啊。ISLAND 也有这个情节（相对论），总感觉似曾相识……
  - 双缝干涉退化（波函数坍缩）时指的观测是量子意义的观测，而不是宏观意义的观测。所以 Observer 还是
- <dtls alt="其他感想（剧透警告）">

  - 我猜到了 Thinker 是谁。
  - 我的理解里，本作由于时穿悖论，因此给打了一个补丁（多世界），但是由于弱因果关系设定，又给多世界引入了不少漏洞。实际上多世界应该是没有因果的。

  </dtls>

- <dtls alt="简单吐槽">

  - _萌 AI 同好会_ 的翻译很有意思，很有~~青春活力~~。
