...
| :----: | :----: | :----: | :----: | :----: |
|osu|81|<text style="color:red;">GS02声卡 -32~-40ms</text><details><summary>其它环境</summary><p>（均为快银轴数据）</p><text style="color:red;"><p>Predator G3-573: -63ms(-55~-70)</p><p>鞋盒机: -13ms</p>将星X15内置声卡: -85ms(-83~-100)</text></details>|30|0|
