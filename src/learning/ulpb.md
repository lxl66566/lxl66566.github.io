...
输入法本质上是一个有限空间映射问题，不同方案都是在做记忆效率和编码效率的权衡。
...
3. 相比于其他输入编码，双拼在编码效率上偏低。

## 推荐

双拼也是有一大堆不同码表的。我使用**小鹤双拼**（领路人的选择），而且我觉得记忆会方便点，同一个键的声母和韵母大多能组合成有意义的字符串。
...
由于形码的记忆成本边际效应比较严重，目前我只学习了基础双拼。

## 输入法

详见 [输入法](../articles/input_method.md) 文章，当前正在使用 Rime。
