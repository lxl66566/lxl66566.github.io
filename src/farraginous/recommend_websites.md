...
很多 pastebin 是自建的，说不上啥时候就寄了。因此如果有长期保存的需求建议还是用些更稳定的。
...
- [pastes.dev](https://pastes.dev/), [termbin](https://termbin.com/)：极简风格
- [pb.nichi.co](https://pb.nichi.co/)：仅支持 paste from cli，极极简
- [bin.outv.im](https://bin.outv.im/)：注重加密
- <https://netcut.cn/>：最长 3 年，有敏感词检测
- <https://pb.moku.llk.moe/>：[编程语言原神](../coding/Rust/index.md)写的，支持语法高亮。
...
- [音乐解锁 (v1.10.3)](https://demo.unlock-music.dev/)：移除已购音乐的加密保护。**开源，但仓库已被 github 封禁。**
  > ~~需要免费下载可以试试[歌词适配](./recommend_packages.md#歌词适配)（这个软件跟歌词确实没啥关系）~~ 已死，默哀
...
- 在线白板画图：
  ...
  - [drauu](https://drauu.netlify.app/)
- 在线画流程图等各种图表：[Mermaid](https://mermaid.live/edit) | [draw.io](https://draw.io) | [processon（国内商业公司，支持 AI 绘画）](https://www.processon.com/)
...
- 物件音效：[音效](https://www.conservethesound.de/) | [音效 2](https://www.ear0.com/) | [小森平](https://taira-komori.jpn.org/freesoundcn.html)
...
- 格式转换：[Pandoc](https://pandoc.org/try)，也可以安装软件使用。example:
  ```sh
  pandoc <from_file> -f latex -t typst -s -o output.typ
  ```
- 生成方格纸：[mygraphpaper](https://www.mygraphpaper.com/index.php?lang=zh-hans)

### 字体相关

- [字体家 字体下载](https://www.zitijia.com/)
- [fontsniff 字体识别](https://fontsniff.com/zh/font-identification)
...
- [wen-ware](https://wen-ware.com/)：类似 GeoGuessr，但是 AI 生成，且需要猜年代
...
- [Switch618 公益分享](https://www.switch618.com/)：破解游戏下载站
