...
crossbeam-channel 被我拉黑了，大家可以选择 [crossfire](https://github.com/frostyplanet/crossfire-rs)。它的 [crates 页](https://crates.io/crates/crossfire) 还有一些跟其他 channel 库（kanel, flume）比的 benchmark。
