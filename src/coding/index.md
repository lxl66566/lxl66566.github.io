...
编程领域，本人比较喜欢做小工具，实用至上。因为喜欢尝试 + 独立开发者，学的东西很多很杂。

参与的开源贡献比较少，毕竟自己的[灵感](../hide/inspiration.md)还有一大堆没写完。不过如果碰到上游问题，顺手修一下也可以接受。
...
当然 AI 时代编程语言间的界限已经更加模糊了，Rewrite It In XXX 是很常见的。所以学习的侧重点也应该随之改变。
