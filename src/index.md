...
20230712 由于依赖地狱把 node_modules 给崩了，救不回来，于是重新配置博客并更换主题为 [VuePress Theme Hope](https://theme-hope.vuejs.press/zh/)。
:::

本博客与其他**文章导向**的博客不同，主要模式为**版块导向**，各版块文章持续更新。
...
## 关于博客
* 使用 [VuePress2](https://v2.vuepress.vuejs.org/zh/) 搭建，[VuePress Theme Hope](https://theme-hope.vuejs.press/zh/) 主题，极简风格 (pure)
