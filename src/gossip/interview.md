...
其次，语言我尽可能避开了 JAVA 和 C++ 这两个最多岗位的。。JAVA 的话我不是后端小子，学校更是啥都不教；C++ 我甚至不敢说我有多会写，怀抱者对《The Book of Modern C++》的恐惧。

然后不论爱好，考虑我的技术栈，我感觉 _测试开发_ 和 _Linux 运维_ 挺适合我的，毕竟前者 python 用得烂熟，也鼓捣过几个爬虫和自动化项目，后者就纯粹是喜欢尝试创造新工具。
