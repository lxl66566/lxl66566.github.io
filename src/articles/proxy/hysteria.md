...
::: details V2rayN 早期以内核插件形式支持 hysteria
...
但是 dae [不支持 hysteria2 的端口跳跃](https://github.com/daeuniverse/dae/issues/683)，也没有什么要做的迹象了。
...
重启服务器就行了。当时没有开端口跳跃，现在看来可能是运营商 QoS 吧。
