...
还有一个学习方法是多看别人的 configuration，~~并且大量摘抄~~。我的配置在[下面](#配置)，还有一些：[ryan4yin's config](https://github.com/ryan4yin/nix-config) [nyancat](https://git.ny4.dev/nyancat/flake/src/branch/master) [wimpysworld](https://github.com/wimpysworld/nix-config) [jackdbd](https://github.com/jackdbd/nix-config) [nmasur](https://github.com/nmasur/dotfiles) [oo-infty](https://github.com/oo-infty/nixos-configurations) [AsterisMono](https://github.com/AsterisMono/flake) [tama-gucci(dendritic pattern)](https://github.com/tama-gucci/.dotfiles)
