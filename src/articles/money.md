...
- 各种均线的组合。比较简单的有 MACD，复杂的有看 6、7 条均线之间的关系的。
...
- 根据网格的原理，我们需要投价格变动较大的币种。（不过所有加密货币币种变动其实都挺大的）
- OKX 的网格可以选择 _做空网格_，_做多网格_ 和 _中性网格_。区别是入场时是否持有空仓/多仓。一般来说选中性即可，做多和做空带有明确的倾向性，具有一定风险。
- 网格碰上小币种说不定会亏，但是做三大币种几乎是稳赚。
...
OKX 的网格策略会自己进行仓位管理，接近强平价时还会停止挂单，并发出警告，还是挺不错的。我把普通做多/做空单换成对应趋势的网格挂单后，爆仓风险降低了许多。
