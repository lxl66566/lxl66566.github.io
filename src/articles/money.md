...
过了一阵子，小学开始搞“爱心账户”，鼓励家长存一笔钱到邮政银行，把利息当成捐款捐给有需要的人。家长给我存了 100，然后学校给捐款的小朋友公开发了证书。现在想起来自己也太善良了，而且小学这样的举动是隐式强迫，因为没有捐款的家庭&孩子会无意识间被差别对待。
...
高中毕业的暑假，我使用支付宝购买黄金理财。支付宝啥都能买，确实方便。当时的金价才 366/g。之后俄乌战争时又加仓了一次，现在以 600+/g 的价格卖了，确实挺赚的。

这几年的金价也算是机缘巧合吧，之后并不能保证金价像之前的房价一样一直涨下去。而且这属于长线理财，周期太长了。因此我选择退出。
...
- 加密货币交易是零和博弈，本质与赌博相近。千万不要犯了赌徒的忌讳。
- 股市和加密货币的相关性：正相关，如果加密货币投资者受到股市惊吓，也会选择抛售。例如 Deepseek 爆火当天。
...
现货交易中不存在杠杆（其实有，不过杠杆是通过“借币”的形式实现的，而不是真正意义上的杠杆）。相比之下，合约交易允许使用杠杆，使得你可以用较少的资金撬动更大的利益。此外，现货交易的手续费通常是合约交易的两倍左右。因此，我建议主要进行合约交易。

然而，现货交易在某些情况下具有优势，例如当你需要**加密货币本身**时。比如你可能需要 ETH 来进行质押，或者需要 SOL 来购买 NFT。不过，对于加密货币的新手和投机者，这些选项可以暂时不予考虑。
...
- 根据网格的原理，我们需要投价格变动较大的币种。（其实都挺大的，BTC 比其他的会小一点）
- OKX 的网格可以选择 _做空网格_，_做多网格_ 和 _中性网格_。区别是入场时是否持有空仓/多仓。一般来说选中性即可；做多和做空带有明确的倾向性，具有相当的风险，与下场做空/做多差别不大。
- ~~网格碰上小币种说不定会亏，但是做三大币种几乎是稳赚。~~（打脸了）

由于我一般做短期（20days），我的网格数量与区间一般设为日 k 线穿过挂单线 20 次以上，一日套利 10 次以上的值。玩策略不用太纠结于两三天的得失。至少也得等 10 天后再看收益。当然，如果策略的杠杆开比较高（10x-20x），可以经常看看 _预估强平价_，跟币价波动做个对比，如果感觉怕了就补点保证金。如果做小币种网格，还可以把等差网格换成等比网格，进一步降低风险。

> 20250203 ETH 暴跌 30%，把我爆了。所以之后我更加注意杠杆倍率和网格区间，更愿意做小倍率宽区间网格，并且配合马丁格尔兜底回血。

OKX 的网格策略会自己进行仓位管理，接近强平价时还会停止挂单，并发出警告，还是挺不错的。我把普通做多/做空单换成对应趋势的网格挂单后，爆仓风险降低了一些。
...
> Trump 币发行时，我是第一次接触新币，亏了一点钱（后来通过策略赚回来了）。之后又经历了 Jambo 预报价和交易阶段，摸了两次新币。

炒新币有着较高的风险；关于新币资质，能上交易所的新币一般都不会太差，不像 pump.fun 的土狗 meme 币，那个[纯纯庞氏骗局](https://www.panewslab.com/zh/sqarticledetails/8sih61h5.html)，千万别碰。

新币发行有一些规律（本人不保证正确性），就是一阵短期上涨，然后接很长的长跌。所以要么盯着初期做多超短线并且及时离场，要么就在顶点做大空。币的吸金程度不同，峰值来得也有快慢，例如 Trump 用了几个小时，Jambo 只用了几分钟，但是后面的长跌都是一致的。
