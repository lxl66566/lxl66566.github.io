...
- 一个是薅羊毛，前 1000 USDC 可以享受 15% 年化，这也太多了吧！

优势：

- htx 可以充 [XMR](#xmr)，其他交易所不支持交易 XMR。
- C2C 有活动，

缺点：

- 不支持美国和加拿大 IP。
- 他妈的，网页端每三天都要重新登录是怎么一回事？
- htx 的前端页面做得挺烂的，不管网页还是移动端都是，延迟高，很卡手。
- 策略机器人只有网格，太少了。而且最小投入金额也太高了，没钱基本玩不了策略，垃圾。
- C2C 的盘口少，验证单太多。还好它的 C2C 有引入些福利活动，救了一下。
- 现货交易，下限价单必须 >=10 USDT，否则就只能下市价单。莫名其妙的规矩。
- htx 的赚币和其他 CEX 差不多，也有提供限时限额的高年化体验卡，薅点羊毛还是不错的。
...
- [OKX 公告](https://www.okx.com/zh-hans/help/section/announcements-latest-announcements)
  - 我自己用 RSSHub 做了 [OKX 的公告订阅](https://docs.rsshub.app/zh/routes/okx)，欢迎使用。但是话又说回来，OKX 的公告基本都是“事后公告”，也就是先上了币才发公告，所以没什么用，不如去 APP 里看活动。
