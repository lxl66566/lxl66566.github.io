      ...
      <table>
        <thead>
          <tr>
            ...
            <th>
              <Explain explanation="支持支付宝、微信、大陆银行卡中的任意一项"
              >大陆支付方式?</Explain>
            </th>
            <th>
            ...
            <th>
              <Explain explanation="用户的海外 IP 地址支持。本人主要看重日本和香港节点的支持度"
              >海外节点兼容性</Explain>
            </th>
            <th>
              <Explain explanation="挂单 ~ 吃单，这里记录的是没有任何交易量的新人手续费"
              >基础合约手续费</Explain>
            </th>
          </tr>
        </thead>
        <tbody>
          <ExpandableListItem
            v-for="item in data"
            :expandable="useSlots()[item.valid_name ?? item.name] != undefined"
          >
            <template #list-content>
              ...
              <td>
                {{
                  (item.基础合约手续费.挂单 ?? "-") + "%" + " ~ " + (item.基础合约手续费.吃单 ?? "-") + "%"
                }}
              </td>
            </template>
