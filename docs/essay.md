...
## 2022
### 2022/08/18
由于我的两个galgame没法正常运行，我认定是不兼容win11的问题，花了几个小时去[搞hyper-v虚拟机](./my_articles.md#对win11的设置)（毕竟是原生的，所以首选了）和出现的亿点bug……最后还是没搞好，愤然选择VMware装上了win10。结果发现玩不了gal的问题是 **[20220815硬盘崩了](./farraginous/log.md#20220815)把文件损坏了**……笑死个人
### 2022/08/17
