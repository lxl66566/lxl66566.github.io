...
|灵感满溢的甜蜜创想|<text style="color:red;">恶性bug：（2次）出现自动强制快进，没有任何办法取消，重启游戏均无法恢复正常。（确定bug出现在存档中的saveg.dat文件中）甚至将存档回档也不行</text>；<!-- 无法关闭操作的效果语音<text style="color:red;">且会覆盖播放中的语音</text>；--> backlog界面下滑滚轮无法返回|
