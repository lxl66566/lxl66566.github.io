...
*（时间统计利用[Tai](../farraginous/recommend_packages.md#tai)作出。由于1.0.0.4版本及之前版本有时长错误bug，此处带`*`则表示统计数据不准确，仅供参考）*
...
|灵感满溢的甜蜜创想|2022.10.04|4|10|8|+40min|
|アンレス テルミナリア|
...
|灵感满溢的甜蜜创想|<text style="color:red;">恶性bug：（1次）出现自动强制快进，没有任何办法取消，重启游戏均无法恢复正常</text>；无法关闭操作的效果语音<text style="color:red;">且会覆盖播放中的语音</text>；backlog界面下滑滚轮无法返回|
